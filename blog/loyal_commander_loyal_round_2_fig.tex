...
\sbox{\mainTableBox}{%
  ...
  \begin{tabular}{c|c|c|c|c|c}
    ...
    \textbf{$\gen{1}$} & \cellcolor{yellow!30}\textcolor{blue}{A} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} \\
    ...
    \textbf{$\gen{4}$} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} & \cellcolor{yellow!30}\textcolor{blue}{A} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} & \cellcolor{red!20}\textbf{\textcolor{red}{R}} \\
    ...
    \textbf{$\gen{3}$} & \cellcolor{blue!20}\textcolor{blue}{A} & \cellcolor{blue!20}\textcolor{blue}{A} & \cellcolor{blue!20}\textcolor{blue}{A} & \cellcolor{blue!20}\textcolor{blue}{A} & \cellcolor{yellow!30}\textbf{\textcolor{blue}{A}} \\
    \hline\hline
